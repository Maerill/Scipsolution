...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 01, 2015 at 01:39 PM
...
('root', '[{"db":"scip","table":"tbl_pic"},{"db":"scip","table":"tbl_users"},{"db":"phpmyadmin","table":"pma_column_info"},{"db":"phpmyadmin","table":"pma_designer_coords"},{"db":"phpmyadmin","table":"pma_history"},{"db":"phpmyadmin","table":"pma_pdf_pages"},{"db":"phpmyadmin","table":"pma_recent"},{"db":"phpmyadmin","table":"pma_relation"},{"db":"cdcol","table":"cds"},{"db":"mysql","table":"user"}]');
...
('root', '2015-06-01 08:50:48', '{"collation_connection":"utf8mb4_unicode_ci"}');
